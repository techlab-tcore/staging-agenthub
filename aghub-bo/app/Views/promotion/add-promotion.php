<section class="card border-light shadow">
    ...
    <div class="card-body">
        ...
        <article class="card-text p-3">
            <?=form_open('',['class'=>'form-validation addPromoForm', 'id'=>'modifyPromoForm', 'novalidate'=>'novalidate']);?>
            <dl class="row m-0">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                            <div class="mb-3">
                                ...
                                <data class="d-block mt-2">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="afterpay" id="afp_false" value="false" checked>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                            <div class="input-group mb-3">
                                ...
                                <input type="number" min="0" class="form-control" name="mins" value="0" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                            <div class="mb-3">
                                ...
                                <data class="d-block mt-2">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="resittype" id="resit_deposit" value="1" checked required>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                            <div class="input-group mb-3">
                                ...
                                <input type="number" min="0" class="form-control" name="totalreceipt" value="0" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                            <div class="mb-3">
                                ...
                                <data class="d-block mt-2">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="contclaim" id="contclaim_no" value="2" checked>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                            <div class="input-group mb-3">
                                ...
                                <input type="number" min="0" class="form-control" name="contclaimday" value="0" required>
                            </div>
                        </div>
                    </div>
                </dd>
                <dd class="col-xl-6 col-lg-6 col-md-6 col-12">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control bg-white" name="start5" value="<?=date('Y-m-d');?>" readonly>
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text"><?=lang('Input.expiredate');?></span>
                        <input type="text" class="form-control bg-white" name="end5" value="<?=date('Y-m-d',strtotime("+30 days"));?>" readonly>
                    </div>
                </dd>
            </dl>
            <div class="mb-3">
...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    const rootElement = document.getElementsByClassName('addPromoForm')[0];
    ...
    $('.addPromoForm').on('submit', function(e) {
        ...
        if (this.checkValidity() !== false) {
            ...
            const spDay = [];
            $.each($(".addPromoForm [name=spDay]:checked"), function() {
                spDay.push($(this).val());
            });
            ...
            .done(function() {
                $('.addPromoForm').trigger('reset');
                $('.addPromoForm').removeClass('was-validated');
            })
            .fail(function() {
