<section class="card border-light shadow">
    ...
    <div class="card-body">
        ...
        <article class="card-text p-3">
            <?=form_open('',['class'=>'form-validation addPromoReadOnlyForm', 'id'=>'modifyPromoForm', 'novalidate'=>'novalidate']);?>
            <div class="mb-3">
...
document.addEventListener('DOMContentLoaded', (event) => {
    $('.addPromoReadOnlyForm').on('submit', function(e) {
        e.preventDefault();
        ...
        if (this.checkValidity() !== false) {
            ...
            $.post('/promotion/read-only/afflb-content/add', {
                params
            ...
            .done(function() {
                $('.addPromoReadOnlyForm').trigger('reset');
                $('.addPromoReadOnlyForm').removeClass('was-validated');
            })
            .fail(function() {
