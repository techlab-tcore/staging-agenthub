<section class="card border-light shadow">
    ...
    <div class="card-body">
        <div class="px-3 mb-3">
            <a class="btn btn-danger bg-gradient shadow" href="<?=base_url('extra/agcomm-config');?>"><i class="las la-long-arrow-alt-left me-1"></i><?=lang('Nav.back');?></a>
        </div>
