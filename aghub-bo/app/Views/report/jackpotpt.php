<div class="card border-light shadow">
    ...
    <div class="card-body">
        <article class="card-text p-3">
            ...
            <table id="jackpotptTable" class="w-100 nowrap table table-sm table-bordered table-hover">
...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    jackpotptTable(fromdate,todate,'<?=$parent;?>');
...
function jackpotptTable(from,to,parent)
{
    const jackpotptTable = $('#jackpotptTable').DataTable({
        ...
        drawCallback: function(oSettings, json) {
            $('#jackpotptTable tbody tr').find('td').not('td:first-child,td:nth-child(2),td:nth-child(3)').addClass('text-end');
            $('#jackpotptTable tbody tr td.dataTables_empty').removeClass('text-end');
        },
        aoColumnDefs: [{
            aTargets: [3,4,5],
...
function loadparent()
{
    ...
    jackpotptTable(start,end,'<?=$parent;?>');
