<div class="card border-light shadow">
    ...
    <div class="card-body">
        <article class="card-text p-3">
            ...
            <table id="affiliateptTable" class="w-100 nowrap table table-sm table-bordered table-hover">
...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    affiliateptTable(fromdate,todate,'<?=$parent;?>');
...
function affiliateptTable(from,to,parent)
{
    const affiliateptTable = $('#affiliateptTable').DataTable({
        ...
        drawCallback: function(oSettings, json) {
            $('#affiliateptTable tbody tr').find('td').not('td:first-child,td:nth-child(2),td:nth-child(3)').addClass('text-end');
            $('#affiliateptTable tbody tr td.dataTables_empty').removeClass('text-end');
        },
        aoColumnDefs: [{
            aTargets: [3,4,5],
...
function loadparent()
{
    ...
    affiliateptTable(start,end,'<?=$parent;?>');
