...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    const depositcommTable = $('#depositcommTable').DataTable({
        ...
        ajax: function(data, callback, settings) {
            ...
            $.ajax({
                url: '/list/report/deposit-commission',
                type: 'post',
                data: payload,
        ...
        drawCallback: function(oSettings, json) {
            $('#depositcommTable tbody tr').find('td').not('td:first-child,td:nth-child(2),td:nth-child(3),td:nth-child(4),td:nth-child(5)').addClass('text-end');
