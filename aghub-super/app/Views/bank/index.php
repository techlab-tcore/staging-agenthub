<section class="card border-light">
    ...
    <div class="card-body">
        <div class="px-3">
            <button type="button" class="btn btn-primary bg-gradient" data-bs-toggle="modal" data-bs-target="#modal-addbank"><i class="las la-plus-circle me-1"></i>Add Bank</button>
        </div>
